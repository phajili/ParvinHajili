...
public interface BooksWS {
    ...
    ResponseEntity getBooksById(int book_id);
    
    ResponseEntity writeComment(int token, int book_id, String comment);
    
    ResponseEntity writeReply(int token, String comment_id, String comment);
}
